...
class Post2 extends StatefulWidget {
  ...
  Post2({this.user, this.currentUser, Key key})
      : super(key: key);

  @override
  State createState() => new Post2State();

  void initState() {}
}

class Post2State extends State<Post2>
    with AutomaticKeepAliveClientMixin<Post2> {
  ...
  Post2State({this.user, this.currentUser});
          ...
          children: <Widget>[
            ...
            new Flexible(
              child: new StreamBuilder(
                stream: Firestore.instance.collection('jod').orderBy("votes").snapshots(),
